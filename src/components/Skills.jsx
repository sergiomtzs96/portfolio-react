...
function Skills() {
    ...
    return (
        <div id="skills" className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col items-center mb-10 w-200">
            ...
            <div className="flex flex-col items-center border-1 border-gray-100 rounded-lg shadow-lg w-200 mb-50">
                <p className="text-2xl font-bold mt-5">Herramientas y Software</p>
                <div className="grid grid-cols-3 grid-rows-4 gap-7 mt-5 mb-5 w-180">
