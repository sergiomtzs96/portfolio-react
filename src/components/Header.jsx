    ...
    return (
        <div id="header" className='mt-20 w-full min-h-screen flex flex-col items-center justify-center text-center gap-y-6 p-2 mx-auto'>
            ...
            <div className='w-full flex flex-col lg:flex-row  gap-4 text-center justify-between items-center p-3' data-aos="fade-down">
                <div className='p-4 bg-gradient-to-r from-cyan-500 to-violet-500 rounded-xl hover:scale-110 transition duration-300 ease-in-out w-full'>
                    <a className=' text-white font-bold' href="#proyects">Ver mis proyectos</a>
                </div>
                <div className='w-full p-4 px-6 border-2 border-blue-500 rounded-xl hover:bg-blue-500 text-blue-500 font-bold hover:text-white transition duration-300 ease-in-out'>
                    <a href="#contact">Contacto</a>
                </div>
                <div className='w-full'>
                    <a href={cv} download className='flex gap-3 bg-gray-100 p-4 rounded-xl p-2 hover:shadow-lg hover:bg-gray-200 transition duration-300 ease-in-out'><img className='w-6' src={download} alt="descarga" />Descargar CV</a>
                </div>
            </div>
